# Class <code>RailroadSwitchControl</code>
...
### Method <code id="toggle-switch">toggleSwitch</code> ()
Toggles the railroad switch like if you interact with it.


### Method <code id="switch-position">switchPosition</code> () → position
Returns the current switch position of this switch.


<b>Return Values:</b>

- <code><b>position</b></code> integer
