...
### Method <code>setText(x, y, str) -> </code>
...
### Method <code>setForeground(r, g, b, a) -> </code>
...
### Method <code>setBuffer(buffer) -> </code>
...
### Method <code>setBackground(r, g, b, a) -> </code>
...
- <code><b>h</b></code> integer
  ...
  The height of the text-grid.
### Method <code>getScreen() -> screen</code>
...
### Method <code>getBuffer() -> buffer</code>
...
### Method <code>fill(x, y, dx, dy, str) -> </code>
...
### Method <code>bindScreen(newScreen) -> </code>
...
### Signal <code>ScreenSizeChanged -> oldW, oldH</code>
...
### Signal <code>OnMouseUp -> x, y, btn</code>
...
5th alt key pressed
6th cmd key pressed
### Signal <code>OnMouseMove -> x, y, btn</code>
...
5th alt key pressed
6th cmd key pressed
### Signal <code>OnMouseDown -> x, y, btn</code>
...
5th alt key pressed
6th cmd key pressed
### Signal <code>OnKeyUp -> c, code, btn</code>
...
5th alt key pressed
6th cmd key pressed
### Signal <code>OnKeyDown -> c, code, btn</code>
...
5th alt key pressed
6th cmd key pressed
### Signal <code>OnKeyChar -> c, btn</code>
